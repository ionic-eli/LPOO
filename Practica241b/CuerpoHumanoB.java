public class CuerpoHumanoB
{
    private String tonoDePiel;
    private float altura;
    private String tipoDeCuerpo;
    protected Apendice apendice;
    protected Higado higado;
    protected Pulmon pulmones;
    protected Corazon corazon;

    CuerpoHumanoB()
    {
        apendice = new Apendice();
        higado = new Higado();
        pulmones = new Pulmon(new Pulmon(), new Pulmon());
        corazon = new Corazon();
    }
